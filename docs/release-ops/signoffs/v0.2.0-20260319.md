...
- Version: 0.2.0
- GeneratedAtUtc: 2026-03-19 15:17:32Z
...
- Evidence index path: docs/release-ops/evidence/indexes/v0.2.0-20260319-evidence.md
- Support bundle evidence path: docs/release-ops/evidence/support-bundles/v0.2.0-pilot-support-bundle-manifest.json
- Correlation trace evidence path: docs/release-ops/evidence/correlation-traces/v0.2.0-pilot-correlation-trace.md
- Rollback rehearsal evidence path: docs/release-ops/evidence/rollback/v0.2.0-rollback-rehearsal.md
- Upgrade validation evidence path: docs/release-ops/evidence/upgrade-validation/v0.2.0-upgrade-validation.md
